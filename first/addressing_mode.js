class Addressing_mode {
    ...
    static relative_base_indexed(str, chip) {
        ...
        return SysConvert.to_decimal(chip.getRegister(seg)) + SysConvert.to_decimal(chip.getRegister(reg_base)) + SysConvert.to_decimal(chip.getRegister(reg_index)) + SysConvert.to_decimal(rel);
    }
