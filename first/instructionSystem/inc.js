class Inc {
    static inc(operand, ram) {
        ...
        if (ram.chip.getRegisterByName(operand)) {
            console.log(1234);
            ...
            ram.chip.setFlagByName('OF', Flags.judgeOf(data1, data2));
            ram.chip.setFlagByName('PF', Flags.judgePf(data2));
            ram.chip.setFlagByName('DF', Flags.judgeDf(data1,data2));
            ram.chip.setFlagByName('IF', Flags.judgeIf(data1,data2));
            ram.chip.setFlagByName('TF', Flags.judgeTf(data1,data2));
